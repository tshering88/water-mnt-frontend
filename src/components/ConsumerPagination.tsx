...
export const ConsumerPagination: React.FC<ConsumerPaginationProps> = ({
  currentPage,
  totalPages,
  limit,
  total,
        ...
        <PaginationContent>
          <PaginationItem>
            <PaginationPrevious
              ...
              className={`cursor-pointer ${currentPage === 1 ? 'pointer-consumers-none opacity-50' : ''}`} size={"icon"}            />
          </PaginationItem>
          ...
          <PaginationItem>
            <PaginationNext
              ...
              className={`cursor-pointer ${currentPage === totalPages
                  ? 'pointer-consumers-none opacity-50'
                  : ''}`} size={"icon"}            />
          </PaginationItem>
        </PaginationContent>
      </Pagination>
